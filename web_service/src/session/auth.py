...
from ..hipotap_common.models.auth import InvalidCredentialsException, UserAlreadyExistsException
...
def signup_user(name, surname, email, password):
    ...
    """
        # call to API Gateway for authentication
        response = requests.post(REGISTER_ENDPOINT, data={'name':name, 'surname':surname, 'email':email, 'password':password})
